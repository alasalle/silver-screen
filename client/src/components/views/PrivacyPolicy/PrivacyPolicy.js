...
export default function PrivacyPolicy() {
  return (
    <div style={{ width: "85%", margin: "1rem auto" }}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Silver Screen.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Silver Screen, accessible from{" "}
            <a
              href="https://silver-screen.alasalle.com"
              rel="external nofollow noopener"
              // eslint-disable-next-line
              target="_blank"
            >
              https://silver-screen.alasalle.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: angela.lasalle91@gmail.com</li>
      </ul>
    </div>
  );
}
